...
proc ::dom::domNode::unset {node query {complain 0}} {
	...
	switch $type {
		...
		empty {if { $complain } { error "No results found for '$query'" }}
		default {if { $complain } { error "$type is an unsupported query result type" }}
	}
}
